...
export async function POST(
  ...
  try {
    ...
    /*
     * A movie can only become
     * featured if it is being
     * published.
     */
    const shouldFeature =
      status ===
    ...
    /*
     * If the new movie is going
     * to be featured, clear the
     * flag from any existing
    ...
    if (
       ...
       * partially-created movie
       * if its relationships fail.
       */
      if (
        relationshipError
      ) {
