...
export const metadata: Metadata = {
  title:
    "Horror Movie News, Trailers & Updates",

  description:
    "The latest horror movie news, trailers, casting updates, release dates and genre stories from The Movie Trailer.",
  ...
  openGraph: {
    ...
    siteName:
      "The Movie Trailer",
    title:
      "Horror Movie News, Trailers & Updates | The Movie Trailer",
    description:
      "The latest horror movie news, trailers, casting updates, release dates and genre stories from The Movie Trailer.",
    url:
      "/horror",
...
export default async function HorrorPage() {
  ...
  if (error) {
    throw new Error(
      `Failed to load horror stories: ${error.message}`,
    );
  }
